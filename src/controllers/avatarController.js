...
const createAvatar = async (req, res) => {
  try {
    const { age, gender, skin_tone, face_shape, hair_style, eye_color, beard_style, facial_expression, height, weight } = req.body;

    if (!age || !gender || !skin_tone || !face_shape || !hair_style || !eye_color || !beard_style || !facial_expression || !height || !weight) {
...
const updateAvatar = async (req, res) => {
  try {
    const allowedFields = ["age", "gender", "skin_tone", "face_shape", "hair_style", "eye_color", "beard_style", "facial_expression", "height", "weight"];
    const updateData = {};
